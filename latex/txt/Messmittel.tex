...
\begin{center}
    ...
    \captionof{figure}[Nano-Pinlayout ]{Nano-Pinlayout \cite{Arduino.cc}}\label{Nano-Pinlayout}
\end{center}

\begin{center}
    \centering
    \includegraphics[width=0.6\textwidth]{img/HX711.png}
    \captionof{figure}[HX711]{HX711 \cite{prilchen.de}}\label{HX711}
\end{center}


\begin{center}
    \centering
    \includegraphics[width=0.8\textwidth]{img/wägezelle_verschaltung.png}
    \captionof{figure}[HX711 Schaltung mit Arduino Nano]{HX711 \cite{prilchen.de}}\label{HX711-Nano-Schaltung}
\end{center}
...
\begin{center}[h!]
    ...
    \captionof{figure}[De- und Repolarisation und Aktionspotential Muskelfasermembran]{De- und Repolarisation und Aktionspotential Muskelfasermembran \cite{Vorlesung Dr. Lehner: Muskulatur-EMG}}\label{Depolarisations- und Repolarisationsverlauf}
\end{center}

Eine Muskelontraktion startet auf Sarkomerebene. Durch das Zusammenwirken aller Sarkomere wird die Umwandlung von chemischer Energie in mechanische Energie als Kontraktion des Muskels sichtbar.\\
\\
