...
Die von der Wägezelle übertragenen Gewichtsdaten der linken und rechten Seite sollen beschreiben wie sehr die jeweilige Seite beansprucht wird.
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{img/pyplots/Integral der Differenz - Giorgio.png.png}\\
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{img/pyplots/Integral der Differenz - Max.png}\\
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{img/pyplots/Integral der Differenz - Felix.png}\\
